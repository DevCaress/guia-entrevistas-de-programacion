...
**Tests**: Behavior-changing code tasks MUST include automated tests unless the
plan documents why automation is not applicable. Documentation-only tasks MUST
include verification for affected structure, links, commands, or examples.
...
- [ ] T004 [P] Configure test, Markdown, link, or example verification tools required by the plan
...
- [ ] T011 [P] Add baseline security and dependency checks required by the plan
- [ ] T012 [P] Add baseline performance measurement or budget checks required by the plan
...
- [ ] T015 [P] [US1] Documentation, link, command, or example verification for affected files
...
- [ ] T022 [US1] Verify UX consistency, performance target, and security expectations from plan.md
...
- [ ] T025 [P] [US2] Documentation, link, command, or example verification for affected files
...
- [ ] T030 [US2] Verify UX consistency, performance target, and security expectations from plan.md
...
- [ ] T033 [P] [US3] Documentation, link, command, or example verification for affected files
...
- [ ] T037 [US3] Verify UX consistency, performance target, and security expectations from plan.md
...
- [ ] TXXX [P] Additional unit tests and documentation verification
- [ ] TXXX Security hardening
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Verify table of contents, affected links, and examples
